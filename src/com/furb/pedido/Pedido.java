...
public class Pedido extends Thread implements Serializable {
	...
	public Pedido(int codigo, ClienteAbstract cliente, Date dataEntrada,
			Date dataEntrega, Endereco enderecoPostoAtend,
			Endereco enderecoEntrega, List<Produto> listaProdutos,
			double valorPedido, double x, double y) {
		this.codigo = codigo;
